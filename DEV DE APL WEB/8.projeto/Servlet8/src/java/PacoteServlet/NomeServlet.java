...
public class NomeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String retornoGetParameterValues[] = request.getParameterValues("estado");
            
            for(String valores: retornoGetParameterValues)
                out.println("<h3> Usando getParameterValues: "+valores+"</h3>");
            ...
            while(indice.hasNext()){
                ...
                for (String value : dados.getValue()) {
                    out.println("<h3>Campo: " + dados.getKey() + " Valor informado pelo usu&aacute;rio: " + value + "</h3>");
                }
            }
